...
enum RPGSkillRegistry {
    ...
    static let all: [RPGSkill] = [
        RPGSkill(
            ...
            passiveWeight: 12, relatedMuscles: [.chest, .arms], category: .attack
        ),
        RPGSkill(
            ...
            passiveWeight: 14, relatedMuscles: [.arms, .legs], category: .attack
        ),
        RPGSkill(
            ...
            passiveWeight: 14, relatedMuscles: [.shoulders, .arms], category: .magic
        ),
        RPGSkill(
            ...
            passiveWeight: 6, relatedMuscles: [.core, .back], category: .magic
        ),
        RPGSkill(
            ...
            passiveWeight: 12, relatedMuscles: [.legs, .cardio], category: .attack
        ),
        RPGSkill(
            ...
            passiveWeight: 7, relatedMuscles: [.chest, .core], category: .defense
        ),
        RPGSkill(
            ...
            passiveWeight: 6, relatedMuscles: [.legs, .cardio], category: .defense
        ),
        RPGSkill(
            ...
            passiveWeight: 10, bossOnly: true, relatedMuscles: [.chest, .core], category: .attack
        ),
    ]
