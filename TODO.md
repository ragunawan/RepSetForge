...
- [ ] Accessibility audit against the ship-blocking checklist (dev spec §7): Dynamic Type to AX5, AX2+ stacked set row (§7a, snapshot-tested at large/xxxLarge/AX1/AX3), 44×44 minimum targets, VoiceOver set-row label + custom "Complete set" action, haptics
